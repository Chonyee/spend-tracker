...
function fuzzyMatchCategory(input) {
  ...
  const keywords = {
    ...
    'House': ['house', 'home', 'furniture', 'appliance', 'decor', 'hardware', 'ikea', 'lowes', 'depot', 'kitchen', 'cleaning', 'household'],
    'Entertainment': ['entertainment', 'movie', 'game', 'streaming', 'netflix', 'spotify', 'concert', 'fun', 'recreation'],
    'Bills & Utilities': ['bill', 'utility', 'utilities', 'electric', 'water', 'internet', 'phone', 'insurance'],
